...
plotExpression <- function(list_markers,
    ...
    if (plot_type == "umap"){
        ...
        p_umap_cluster = ggplot(umap,aes_string(x="UMAP_1",y="UMAP_2",col="clusters"))+
            ...
            theme_classic() +
            theme(legend.position="none", #as seurat labels will be added
        ...
        plot_df_melt$variable <- sub("\\\n.*", "", plot_df_melt$variable)
        ...
        return(list(p1, p_umap)) #clustering and expression level
    }
